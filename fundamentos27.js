...
function calcularCrescimento(altura1, taxa1, altura2, taxa2) {
    if (altura1 == altura2) {
        if (taxa1 > taxa2) {
            return 'A criança 1 ultrapassará a criança2 em 1 ano.'
        } else if (taxa1 < taxa2) {
            return 'A criança 1 ultrapassará a criança2 em 1 ano.'
        } else {
            return 'As crianças tem a mesma altura e o crescimento'
        }
    } else {
        if (altura1 > altura2) {
            if (taxa1 >= taxa2) {
...
console.log(calcularCrescimento(123, 2, 3, 6))
console.log(calcularCrescimento(160, 5, 10, 2))
