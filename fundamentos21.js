...
console.log(calcularPreco(3))
console.log(calcularPreco(18))
console.log(calcularPreco(29))
console.log(calcularPreco(87))
console.log(calcularPreco(20))
console.log(calcularPreco(96))
